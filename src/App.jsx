...
const MemoryGame = () => {
  ...
  const initializeGame = (theme) => {
    // If theme is provided, set it; otherwise keep current theme
    if (theme) {
      setSelectedTheme(theme);
    }

    const currentTheme = theme || selectedTheme;
    const symbols = themes[currentTheme].emojis;
      ...
      {gameStarted && (
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: '28px' }}>{themes[selectedTheme].icon}</span>
